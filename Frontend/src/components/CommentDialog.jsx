import {
  ...
  export default function CommentDialog() {
    ...
    const LoginForm = (<Card className="mx-auto w-full max-w-[24rem]">
    <CardBody className="flex flex-col gap-4">
      <Typography variant="h4" color="white" className="bg-[#918876] rounded-md p-2">
        Sign In
      </Typography>
      <Typography
  ...
  const SignUpForm = (<Card className="mx-auto w-full max-w-[24rem]">
  <CardBody className="flex flex-col gap-4">
    <Typography variant="h4" color="white" className="bg-[#918876] rounded-md p-2">
      Sign Up
    </Typography>
